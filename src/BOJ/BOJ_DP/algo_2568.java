...
public class algo_2568 {
    static int N = 0, cnt = 0;
    static int[] DP;
    static Pair[] tracking;
    static ArrayList<Inf> An = new ArrayList<Inf>();
    static Stack<Integer> Rm = new Stack<Integer>();
...
class Inf implements Comparable<Inf>{//정렬을 위한 Comparable 인터페이스 상속
    int Left;
    int Right;
